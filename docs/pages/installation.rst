...
* `South <http://south.aeracode.org/>`_. Only required if you're using Django <= 1.6.
...
#. Add to your ``INSTALLED_APPS`` setting::
    ...
    INSTALLED_APPS = (
         ...
         'photologue',
         'south', # Not required for Django >= 1.7 - use Django's own migration framework instead.
         'sortedm2m',
    )
...
~~~~~~~~~~~~~~~~~~~~~~
Photologue will use South to manage database migrations; you'll need to add the following to your settings::
